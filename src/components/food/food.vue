<template>
  <transition name="move">
    <div v-show="showFlag" class="food" ref="foodIn">
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <ratingselect @add1="addIterm" @change1="toggle" :select-type="selectType" :only-content="onlyContent"
    ...
    export default {
      ...
      methods: {
        show () {
          ...
          this.$nextTick(() => {
            if (!this.scoll) {
              this.scoll = new BScorll(this.$refs.foodIn, {
                click: true
              })
            } else {
              this.scoll.refresh()
